  ...
  return (
    <main className="min-h-screen overflow-x-hidden">
      <div className="relative h-screen w-full bg-black">
        ...
        <div
          className="absolute bottom-8 right-4 md:right-4 xl:right-48 xl:top-[80%] xl:bottom-auto xl:-translate-y-1/2 w-[240px] sm:w-[280px] xl:w-[340px] h-[180px] sm:h-[210px] xl:h-[250px] rounded-[25px] xl:rounded-[35px] overflow-hidden hidden sm:block"
          style={{
