...
const QUICK_BROWSE_DATA: QuickBrowseSectionData[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'promos', label: 'Promos', icon: Star, href: '/products?category=Magic-The-Gathering&rarity=promo', description: 'Special prints', imageSrc: '/images/promos-collection-v1.png' },
            { id: 'secret-lair', label: 'Secret Lair', icon: Ghost, href: '/products?category=Magic-The-Gathering&set=secret-lair', description: 'Exclusive drops', imageSrc: '/images/secret-lair-collection-v1.jpg' },
        ]
    },
    {
        id: 'store-picks',
        ...
        items: [
            ...
            { id: 'trending', label: 'Trending', icon: Flame, href: '/products?category=Magic-The-Gathering&sort=trending', description: 'Hot right now', imageSrc: '/images/trending-store-pick-v1.png' },
            { id: 'recently-added', label: 'Recently Added', icon: Box, href: '/products?category=Magic-The-Gathering&sort=date_added', description: 'Fresh stock', imageSrc: '/images/recently-added-store-pick-v1.png' },
        ]
    }
];
